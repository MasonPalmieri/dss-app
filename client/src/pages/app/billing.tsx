...
const PLANS = [
  {
    ...
    name: "Individual",
    monthlyPrice: 4.99,
    annualPrice: 4.17, // $49.99/yr
    annualTotal: 49.99,
    desc: "For solo professionals, founders, and personal use.",
    features: [
  ...
  },
  {
    ...
    annualPrice: 19.99,
    annualTotal: null,
    desc: "For companies and teams. $2.99/month per additional user.",
    features: [
  ...
  },
  {
    ...
    annualPrice: null,
    annualTotal: null,
    desc: "Custom plans for large organizations.",
    features: [
